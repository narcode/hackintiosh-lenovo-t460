 ...
 *
 * Disassembly of DSDT.aml, Tue Apr 16 21:29:15 2019
 *
 ...
 */
DefinitionBlock ("", "DSDT", 2, "LENOVO", "TP-R06  ", 0x00001230)
{
    /*
     * iASL Warning: There were 11 external control methods found during
     * disassembly, but only 7 were resolved (4 unresolved). Additional
    ...
    OperationRegion (MNVS, SystemMemory, 0xB7F7C018, 0x1000)
    ...
    OperationRegion (GNVS, SystemMemory, 0xB7F6A000, 0x0600)
